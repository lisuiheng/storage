...
import cn.com.kxcomm.common.resourse.file.Config;
...
public class ClientTest {
    ...
    @Test
    public void test() {
//        Response response = Api.send(new Request(1L, 1L, "coms"));
    ...
    public void upload() throws IOException, NoSuchAlgorithmException {
        Long upload = Api.upload(new File("/home/lee/workspace/java/test/file/client/src/main/resources/1.txt"), 1L, loginOperId, headCorpId, platformCode,
