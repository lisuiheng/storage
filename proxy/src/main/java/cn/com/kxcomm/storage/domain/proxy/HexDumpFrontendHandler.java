...
//public class HexDumpFrontendHandler extends ChannelInboundHandlerAdapter {
//    private final Logger log = LoggerFactory.getLogger(HexDumpFrontendHandler.class);
//
...
//
//    @Autowired
//    public HexDumpFrontendHandler(ProxyConfig proxyConfig) {
...
//        for (Channel outboundChannel : outboundChannelMap.storageLocalClients()) {
